...
public class SeparableConvolutionTest {
    ...
    public void rndSepTest() {
        ...
        int[] img1NonSep = ImageProcessor.gaussianBlurNS(img1, 10, 10, 3);
        int[] img2NonSep = ImageProcessor.gaussianBlurNS(img2, 10, 10, 3);
        int[] img3NonSep = ImageProcessor.gaussianBlurNS(img3, 10, 10, 3);
